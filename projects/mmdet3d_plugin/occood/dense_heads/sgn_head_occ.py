...
from projects.mmdet3d_plugin.occood.utils.ssc_loss import BCE_ssc_loss
...
class SGNHeadOcc(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        # (1/1 resolution)
        # self.deconv_1_2__1_1 = nn.ConvTranspose2d(int(f/2), int(f/1), kernel_size=4, padding=0, stride=4)
        self.deconv_1_2__1_1 = nn.ConvTranspose2d(
            in_channels=int(f/2),   
            out_channels=int(f/1),  
            kernel_size=4,
            stride=2,
            padding=1,
            output_padding=0
        )
        self.conv1_1         = nn.Conv2d(int(f) + int(f/1), int(f), kernel_size=3, padding=1, stride=1)
        self.conv_out_scale_1_1 = nn.Conv2d(int(f), int(f), kernel_size=3, padding=1, stride=1)
    ...
    def forward(self,  mlvl_feats, img_metas, target):
        ...
        # print('out_scale_1_2__2D',out_scale_1_2__2D.shape)
        # Out 1_1 (256x256 resolution)
        out_1 = self.deconv_1_2__1_1(out_scale_1_2__2D)  
        # print('out_1',out_1.shape)
        out_1 = torch.cat((out_1, _skip_1_1), dim=1)       
        # print('out_1',out_1.shape)
        out_1 = F.relu(self.conv1_1(out_1))               
        # print('out_1',out_1.shape)
        out_scale_1_1__2D = self.conv_out_scale_1_1(out_1) 
        # print('out_scale_1_1__2D',out_scale_1_1__2D.shape)

        out_scale_1_1__3D, out_guidance= self.seg_head_1_1(out_scale_1_1__2D) # [1, 20, 32, 256, 256]
        out_scale_1_1__3D = out_scale_1_1__3D.permute(0, 1, 3, 4, 2) # [1, 20, 256, 256, 32]
        # print('out_scale_1_1__3D',out_scale_1_1__3D.shape)
        ...
        out['occ_full'] = out_scale_1_1__3D
