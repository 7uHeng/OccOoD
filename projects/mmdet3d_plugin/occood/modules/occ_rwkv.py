...
class Occbranch(nn.Module):
    ...
    def forward(self, x):
        ...
        # Multi-scale residual blocks
        res1 = self.block_1(out)  # [B, 32, 64, 64, 8] scale 1/2
        res2 = self.block_2(res1)  # [B, 64, 32, 32, 4] scale 1/4

        # BEV projection: flatten depth dim into channel dim, decoupled later
        ...
        return dict(
            mss_bev_dense = [bev_res, bev_res1, bev_res2]
        )