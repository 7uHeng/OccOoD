...
class Sem_RWKV(nn.Module):
    ...
    def forward(self, vw_features, coord_ind):
        ...
        proj_vw1_down = scatter(proj_vw1, unq_inv, method="max", dim=0)  # Reduced resolution
        ...
        proj_vw2_down = scatter(proj_vw2, unq_inv_1, method="max", dim=0)  # Reduced resolution
